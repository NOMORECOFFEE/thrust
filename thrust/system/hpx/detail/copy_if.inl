...
struct body
{
  ...
  body(body& b, ::hpx::split)
    : first(b.first), stencil(b.stencil), result(b.result), pred(b.pred), sum(0)
  {}

  void operator()(const ::hpx::blocked_range<Size>& r, ::hpx::pre_scan_tag)
  {
  ...
  void operator()(const ::hpx::blocked_range<Size>& r, ::hpx::final_scan_tag)
  {
                         ...
                         Predicate pred)
{
  ...
  if (n != 0)
  {
    ...
    ::hpx::parallel_scan(::hpx::blocked_range<Size>(0,n), body);
