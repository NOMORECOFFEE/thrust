                    ...
                    OutputIterator result)
{
  ...
  return thrust::system::hpx::detail::dispatch::copy(exec,first,last,result,traversal());
} // end copy()
                      ...
                      OutputIterator result)
{
  ...
  // dispatch on minimum traversal
  return thrust::system::hpx::detail::dispatch::copy_n(exec,first,n,result,traversal());
} // end copy_n()
